...
data_path = 'root://dc2-grid-64.brunel.ac.uk//dpm/brunel.ac.uk/home/cms//store/user/phy6phs/'
datasets = {'DoubleMu' : [data_path + 'DoubleMu_EcalRecover_11Dec2012-v1_AOD_nTuple_v10_GoldenJSON_diLeptonPlus2Jets_final',
                            data_path + 'DoubleMu_Run2012A-22Jan2013-v1_AOD_nTuple_v10_GoldenJSON_diLeptonPlus2Jets_final',
                            data_path + 'DoubleMu_Run2012B-13Jul2012-v4_AOD_nTuple_v10_GoldenJSON_diLeptonPlus2Jets_final',
                            data_path + 'DoubleMu_Run2012C-24Aug2012-v1_AOD_nTuple_v10_GoldenJSON_diLeptonPlus2Jets_final',
			    data_path + 'DoubleMu_Run2012C-PromptReco-v2_AOD_nTuple_v10_GoldenJSON_diLeptonPlus2Jets_final',
			    data_path + 'DoubleMu_Run2012D-PromptReco-v1_AOD_nTuple_v10_GoldenJSON_diLeptonPlus2Jets_final'],
		 'TTGamma' : [mc_path + 'LHE2EDM_WHIZARD_2to5_ttA/nTuple_v10_Summer12-PU_S7_START52_V9-v1_diLeptonPlus2Jets_final'],	    	
                 'TTJet' : [mc_path + 'TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V7C-v1_AODSIM_nTuple_v10_diLeptonPlus2Jets_final'],
